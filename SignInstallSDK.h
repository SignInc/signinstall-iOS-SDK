...
@protocol SignInstallDelegate <NSObject>
@optional
...
@interface SignInstallSDK : NSObject


/// 初始化SignInstall SDK
/// @param delegate 委托方法所在的类的对象
/// @discussion 调用该方法前，需在Info.plist文件中配置键值对,键为com.SignInstall.APP_KEY不能修改，值为相应的应用的appKey，可在SignInstall官方后台查看
+ (void)initWithDelegate:(id<SignInstallDelegate> _Nonnull)delegate;
...
/// 注册量统计
/// @discussion 使用SignInstallSDK 控制中心提供的渠道统计时，在App用户注册完成后调用，可以统计渠道注册量。
...
/// @return bool  URL是否被SignInstallSDK识别
